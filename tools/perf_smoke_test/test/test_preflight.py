...
from bisection.preflight import GpuInfo, parse_nvidia_smi_query, run_preflight  # noqa: E402
...
class TestRunPreflight:
    ...
    def test_low_disk_space_warns_before_reconstruction(self, tmp_path: Path, monkeypatch) -> None:
        ...
        monkeypatch.setattr("bisection.preflight.shutil.disk_usage", fake_disk_usage)
        cmds = _FakeCommands({_SMI: (0, "NVIDIA L40S, 550.90.07, 46068\n")})
        report = run_preflight(
